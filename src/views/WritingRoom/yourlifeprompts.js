const prompts = {
  earlyChildhood: {
    ...
    prompts: [
      { id: "earlychildhood_1", question: "test prompt" },
  ...
  adolescence: {
    title: "Adolescence",
    prompts: [
      { id: "adolescence_1", question: "test prompt"}
  ...
  youngAdulthood: {
    ...
    prompts: [
      { id: "youngadulthood_1", question: "test prompt" }
  ...
  middleAdulthood: {
    ...
    prompts: [
      { id: "middleadulthood_1", question: "test prompt" }
  ...
  olderAdulthood: {
    ...
    prompts: [
      { id: "olderadulthood_1", question: "test prompt" }
